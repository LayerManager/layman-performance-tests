...
from .geoserver import wms_direct
from .error_class import LaymanError
...
PUBLICATION_TYPES_DEF = {
    MAP_TYPE: PublicationTypeDef(url_param_name='mapname',
                                 ...
                                 source_path='../layman/sample/layman.map/small_map.json',
    ...
    LAYER_TYPE: PublicationTypeDef(url_param_name='layername',
                                   ...
                                   source_path='../layman/sample/layman.layer/small_layer.geojson',
...
class RestClient:
    ...
    def ensure_reserved_username(self, *, username, headers=None, actor_name=None):
        headers = headers or {}
        users = self.get_users(headers=headers)
        usernames = [user['username'] for user in users]
        if username not in usernames:
            self.reserve_username(username, headers=headers, actor_name=actor_name)

    def get_users(self, *, headers=None):
        headers = headers or {}
        r_url = f"{self.base_url}/rest/users"
